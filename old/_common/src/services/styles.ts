...
import { bash, dependencies, toCssValue } from "../lib/utils";
...
const style_path = `/home/alienware/.config/ags/_common/src/styles`;
const style_files = [
...
export async function resetCss() {
   ...
   try {
      const vars = `/home/alienware/.config/ags/_common/shell/variables.scss`;
      const scss = `/home/alienware/.config/ags/_common/shell/main.scss`;
